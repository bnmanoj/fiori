		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Table details",
									"targetURL": "#comsapztable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapztable-display": {
								"semanticObject": "comsapztable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.ztable",
									"url": sap.ui.require.toUrl("com/sap/ztable")
								}
							}
						}
					}
