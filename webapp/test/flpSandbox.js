		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#cmdsapccztype-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cmdsapccztype-display": {
								"semanticObject": "cmdsapccztype",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cmd.sap.cc.ztype",
									"url": sap.ui.require.toUrl("cmd/sap/cc/ztype")
								}
							}
						}
					}
